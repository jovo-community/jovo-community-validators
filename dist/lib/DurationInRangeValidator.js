...
// @ts-ignore
const duration_iso_8601_1 = __importDefault(require("duration-iso-8601"));
class DurationInRangeValidator extends jovo_core_1.Validator {
    ...
    validate() {
        ...
        if (input && input.value) {
            const minSeconds = duration_iso_8601_1.default(this._minDuration);
            const maxSeconds = duration_iso_8601_1.default(this._maxDuration);
            ...
            const inputSeconds = duration_iso_8601_1.default(input.value);
            if (!inputSeconds) {
